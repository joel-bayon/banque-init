...
banqueApp.controller ('compteController', [ '$http', '$scope', function($http, $scope) {
	...
	$scope.loadAll = function() {
		$http.get('http://localhost:8080/banque-init/spring/rest/compte').then(function(value) {
	...
	$scope.load = function(id) {
		$http.get('http://localhost:8080/banque-init/spring/rest/compte/'+id).then(function(value) {
